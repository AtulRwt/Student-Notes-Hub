...
-- CreateIndex
CREATE INDEX "Notification_causerId_idx" ON "Notification"("causerId");
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_causerId_fkey" FOREIGN KEY ("causerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
